...
// import TBAuction from '../TB/TBAuction';
import TBWaitAnnounceAuction from '../TB/TBWaitAnnounceAuction';
import TBInProAnAuction from '../TB/TBInProAnAuction';
// import AnnounceAuction from './AnnounceAuction';
    ...
    <div style={{ backgroundColor: '#efefef', height: '100vh' }}>
      <Box sx={{ display: 'flex' }}>
        ...
        <Box component="main" sx={{ overflow: 'auto' }}>
          <SubHeader />
          <SubHeader Auction="ชะลอขายทอดตลาด"
            AnnounceAuction="ประกาศขายทอดตลาด"
          />
          ...
          <Grid container spacing={1} sx={{ padding: '20px 20px' }}>
            <Grid item xs={12} sm={12} md={12} sx={{
              ...
              <Typography sx={{ marginLeft: '15px' }}>ทรัพย์อยู่ระหว่างการขายทอดตลาด</Typography>
              <Divider sx={{ BorderWidth: 1, borderColor: '#1530A8' }} />
