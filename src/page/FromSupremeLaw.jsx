...
const rowsData = [
    { id: 1, TextDocument: '2301 - เอกสารประกอบการพิจารณาของยื่น/งดฎีกา', Day: '0000002666824', Document: 3100300320047, Name: 'นางสาวKOK', Data: 'KK', },
];
const FromSupremeLaw = () => {
                ...
                <Grid container spacing={1} sx={{ padding: '20px 20px' }}>
                    <Grid item xs={12} sx={{
                        ...
                        <Grid container spacing={1} sx={{ padding: '40px' }}>
                            <Grid item xs={12}>
                                <Typography>
                                    ความคิดเห็นทนาย : ขอยื่นฎีกา <span style={{ color: 'red' }}>*</span>
                                    <TextField
                                        multiline
                                        rows={4}
                                        variant="outlined"
                          ...
                          <Button sx={{background: 'linear-gradient(90deg, #081342, #102583, #1530A8)', color: 'white'}}>
                           <SaveIcon/> <span style={{marginLeft: '5px'}}>บันทึก</span> 
                            ...
                            {/* <Grid item xs={5} sm={5} md={12} sx={{ textAlign: 'center', marginTop: '20px' }}>
                                <AlertSave />
                            </Grid> */}
                        </Grid>
                    </Grid>
