...
import { Grid, Typography, Divider, TextField, FormControl, Select, MenuItem, Box } from '@mui/material'
import TBEditSPL from '../TB/TBEditSPL';
import TestMenu from '../component/TestMenu';
const EditSupremeLaw = () => {
