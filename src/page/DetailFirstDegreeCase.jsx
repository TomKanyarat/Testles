...
function DetailFirstDegreeCase() {
    return (
        <div>
            <div style={{ backgroundColor: '#efefef', height: '100vh' }}>
                ...
                <Grid container spacing={1} sx={{ padding: '20px', }}>
                    <Grid item xs={11} sm={12} md={11} sx={{
                        ...
                        <Typography sx={{ marginLeft: '15px', fontWeight: 'bold' }}>ออกคำบังคับคดีชั้นต้น</Typography>
                        <Divider sx={{ borderColor: '#1530A8' }} />
                        <Link to="/page/FromFirstDegreeeCase" >
...
export default DetailFirstDegreeCase