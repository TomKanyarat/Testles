...
import TBFirstDegreeCase from '../TB/TBFirstDegreeCase';
...
const Auction = () => {
    ...
    return (
        ...
        <div style={{ backgroundColor: '#efefef', height: '100vh', width: '100vw' }}>
            <Box sx={{ display: 'flex' }}>
                <TestMenu />
                ...
                <Box component="main" sx={{ overflow: 'auto',}}>
                    ...
                    <Grid container spacing={1} sx={{ padding: '20px 20px' }}>
                        <Grid item xs={12} sm={12} md={12} sx={{
                            ...
                            <Typography sx={{ marginLeft: '15px' }}>ออกคำบังคับคดีชั้นต้น</Typography>
