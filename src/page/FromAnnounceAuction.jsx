                ...
                <Grid item xs={12} sm={12} md={12} sx={{
                    ...
                    <Grid container spacing={2} sx={{ padding: '5px 20px' }}>
                        <Grid item xs={12} sm={12} md={12} >
                            <Typography>ข้อมูลทรัพย์ที่จะยึด <span style={{ color: 'red' }}>*</span></Typography>
                            <TBFromAnnounceAuction />
                        </Grid>
                    </Grid>
                    ...
                    <Grid container spacing={2} sx={{ padding: '5px 20px' }}>
                        <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={thLocale}>
                            <Grid item xs={12} sm={5} md={4}>
                                <Typography>ขายนัดที่ 1 <span style={{ color: 'red' }}>*</span></Typography>
                                <DatePicker
                                    value={DueDate}
                    ...
                    <Grid container spacing={2} sx={{ padding: '5px 20px' }}>
                        <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={thLocale}>
                            <Grid item xs={12} sm={5} md={4}>
                                <Typography>ขายนัดที่ 2 <span style={{ color: 'red' }}>*</span></Typography>
                                <DatePicker
                                    value={DueDate}
                                    onChange={(newValue) => setDueDate(newValue)}
                                    slotProps={{
                    ...
                    <Grid container spacing={2} sx={{ padding: '5px 20px' }}>
                        <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={thLocale}>
                            <Grid item xs={12} sm={5} md={4}>
                                <Typography>ขายนัดที่ 3 <span style={{ color: 'red' }}>*</span></Typography>
                                <DatePicker
                                    value={DueDate}
                                    onChange={(newValue) => setDueDate(newValue)}
                                    slotProps={{
                    ...
                    <Grid container spacing={2} sx={{ padding: '5px 20px' }}>
                        <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={thLocale}>
                            <Grid item xs={12} sm={5} md={4}>
                                <Typography>ขายนัดที่ 4 <span style={{ color: 'red' }}>*</span></Typography>
                                <DatePicker
                                    value={DueDate}
                                    onChange={(newValue) => setDueDate(newValue)}
                                    slotProps={{
                    ...
                    <Grid container spacing={2} sx={{ padding: '5px 20px' }}>
                        <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={thLocale}>
                            <Grid item xs={12} sm={5} md={4}>
                                <Typography>ขายนัดที่ 5 <span style={{ color: 'red' }}>*</span></Typography>
                                <DatePicker
                                    value={DueDate}
                                    onChange={(newValue) => setDueDate(newValue)}
                                    slotProps={{
                    ...
                    <Grid container spacing={2} sx={{ padding: '5px 20px' }}>
                        <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={thLocale}>
                            <Grid item xs={12} sm={5} md={4}>
                                <Typography>ขายนัดที่ 6 <span style={{ color: 'red' }}>*</span></Typography>
                                <DatePicker
                                    value={DueDate}
                                    onChange={(newValue) => setDueDate(newValue)}
                                    slotProps={{
                    ...
                    <Grid item xs={12} sm={6} md={4} sx={{ padding: '5px 20px' }}>
...
export default FromAnnounceAuction