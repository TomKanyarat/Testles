...
export default function SupremeLawTB() {
    return (
                        ...
                        {rows.map((row) => (
                            <TableRow key={row.id}>
                                ...
                                <TableCell sx={{ textAlign: 'center' }}>{row.TakingAction === 'Button' && (
                                    <Link to="/page/FromSupremeLaw" style={{ textDecoration: 'none', color: 'inherit' }}>
                                        <Button sx={{ color: 'black', border: '1px solid #ccc', height: '30px' }}>
                                            ฎีกา
                                        </Button>
                                    </Link>
                                )}</TableCell>
