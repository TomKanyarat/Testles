...
const columns = [
    ...
    { id: 'TakingAction', label: 'รายละเอียดข้อมูล', minWidth: 170, align: 'center' },
];
...
export default function TBForcedWarrant() {
    return (
                        ...
                        {rows.map((row) => (
                            <TableRow key={row.id}>
                                ...
                                <TableCell sx={{ textAlign: 'center' }}>{row.TakingAction === 'Button' && (
                                    <Link to="/page/FromForcedWarrant" style={{ textDecoration: 'none', color: 'inherit' }}>
