...
import { Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Checkbox, Typography, Divider, Button } from '@mui/material';
...
export default function DataTable() {
    ...
    // ตรวจว่ามีรายการไหนถูกเลือกหรือไม่
            ...
            <Button sx={{
                ...
                onClick={() => {
                    if (hasSelectedRows) {
                        ...
                        window.location.href = "/page/SueFrom";
                    }
                }}
            >
                <AddIcon />สร้างคำฟ้อง
